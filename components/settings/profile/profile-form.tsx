...
export function ProfileForm() {
  ...
  return (
    <div className="space-y-6">
      {/* Your email - Resend style: card section */}
      ...
      {/* Invites - Resend style: card section */}
      <Card className="bg-muted/30">
        <CardContent className="pt-6">
          <div>
            <h3 className="text-sm font-semibold mb-1">Invites</h3>
            <p className="text-sm text-muted-foreground">There are no pending invites.</p>
          </div>
        </CardContent>
      </Card>

      {/* Teams - Resend style: card section (only in organization mode) */}
          ...
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              {teams.length > 0 ? (
                ...
                <p className="text-sm text-muted-foreground">You are not part of any teams.</p>
              )}
            </div>
          </CardContent>
        </Card>
      ...
      {/* Authentication - Resend style: card section */}
      <Card className="bg-muted/30">
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div>
      ...
      {/* Multi-Factor Authentication - Resend style: card section */}
      <Card className="bg-muted/30">
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div>
      ...
      {/* Delete Account - Resend style: card section (conditional messaging) */}
      <Card className="bg-muted/30">
        <CardContent className="pt-6">
          <div className="space-y-4">
            <div>
